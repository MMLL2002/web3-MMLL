      ...
      <section id="新闻" className="relative py-20">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-5 sm:mt-12 md:grid-cols-2 xl:grid-cols-3">
            {[
              { t: "AI Agents + RWA 融合爆发，2026 Davos 重点议题", d: "AI Agent 与 RWA 资产正在深度融合，2026 年达沃斯论坛将焦点对准了这一新兴趋势。" },
              { t: "机构加速 tokenized 资产，RWA 市场 cap 超 220 亿美元", d: "传统金融机构加速入场，RWA 代币化资产总市值已突破 220 亿美元。" },
              { t: "ETH 稳定币与 RWA 成 DeFi 新支柱，2026 或迎超级周期", d: "以太坊上稳定币与 RWA 资产正在成为 DeFi 生态新的核心支柱。" },
              { t: "香港 Web3 政策持续利好，跨境区块链项目推进", d: "香港特区政府持续推出 Web3 支持政策，跨境区块链项目加速落地。" },
              { t: "主流交易所加码 AI Agent 赛道，自动化研究工具升温", d: "多家主流交易所宣布布局 AI Agent 赛道，推出自动化研究和交易工具。" },
              { t: "稳定币结算场景扩展，链上支付继续靠近真实业务", d: "稳定币在跨境支付、供应链金融等场景的应用正在快速扩展。" },
            ].map((item, i) => (
              <Card key={i} className="overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-violet-300/30 hover:shadow-glow h-full">
                <CardHeader>
                  ...
                  <CardTitle className="leading-7 text-sm">{item.t}</CardTitle>
                  <CardDescription className="leading-6 mt-2">{item.d}</CardDescription>
                </CardHeader>
              </Card>
            ))}
          </div>
